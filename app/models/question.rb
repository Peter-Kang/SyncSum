...
#  def self.most_popular commented out deemed unesscary good for reusability jun 22 2013
...
#  end
  ...
  def self.sortby(newest, oldest, answer, review, most_popular, category, importance, skip_ids, cu)
	...
	answer =  answered(cu).sort{|a, b| a.amount_of_candidates <=> b.amount_of_candidates}.reverse
      end
    elsif answer
      if oldest
